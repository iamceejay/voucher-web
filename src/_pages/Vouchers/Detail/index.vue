        ...
        >
          ...
          >
            <InputField
              ...
              :rules="`required|decimal:2|min_value:${ (VOUCHER.type == 'quantity') ? VOUCHER.qty_min : VOUCHER.val_min }|max_value:${ (VOUCHER.type == 'quantity') ? VOUCHER.qty_max : VOUCHER.val_max }`"
              :note="`Value from 
              ${ 
