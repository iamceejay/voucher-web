<template>
  <div>
    <div
      class="bg-white h-32 md:h-64 overflow-hidden relative w-full"
    ...
    >
      ...
      <div
        class="absolute bg-black bg-opacity-50 flex inset-0 items-center justify-center  text-2xl md:text-3xl text-white"
      >
    ...
    <MainLayout>
      <template #content>
        <div
          ...
          class="flex flex-col mt-32 md:mt-64 mx-auto px-8 w-full"
        ...
        >
          ...
          <div class="flex justify-end">
            ...
            >
              <svg
                class="border border-peach h-4 icon mr-2 rounded-full text-peach w-4"
              >
