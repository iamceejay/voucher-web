  ...
  <MainLayout>
    <template #content>
      <div v-if="!IS_LOADING.status" class="content-container flex flex-col w-full px-8">
        ...
        <div class="w-full flex flex-col mb-5">
          <div class="border-b-2 font-medium mb-8 pb-2 text-2xl w-full">Bestellungen</div>
          <span class="text-sm font-semibold mb-8">Rechnungen aus einem bestimmten Zeitraum herunterladen</span>
          ...
          <div class="flex flex-col">
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
              <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="overflow-hidden border border-gray-500">
                  <table class="min-w-full divide-y divide-gray-500">
                    <thead class="bg-gray-50">
                      <tr>
                        <th scope="col" class="px-6 py-3 text-left text-sm font-semibold text-peach">
                          Kanal
                        </th>
                        <th scope="col" class="px-6 py-3 text-left text-sm font-semibold text-peach">
                          Name
                        ...
                        <td class="px-6 py-4 whitespace-nowrap flex">
                          <button
                            ...
                            @click="onGenerateInvoice(row)">
                             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-6 h-6 mx-auto text-peach" viewBox="0 0 16 16">
          ...
          <div v-if="WALLETS.data != 0"
            ...
            <span class="mx-8"> {{WALLETS.current_page}} von {{WALLETS.last_page}} </span>
            <button
              class="list-pagination"
