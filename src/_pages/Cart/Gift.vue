          ...
          this.$swal({
            ...
            html: `<style>.swal2-popup{border: 5px solid #FF5563!important; border-radius: 0!important; }</style>
                  ...
                  <li class="flex gap-3 text-left">
                    ...
                    <span>Gutschein wurde erfolgreich versendet.</span>
                  </li>
                  <li class="flex gap-3 text-left">
                    <i class="fa-check-circle fas mt-0.5 text-green-500 text-xl opacity-0"></i>
                    <span><strong>oder</strong></span>
                  </li>
                  <li class="flex gap-3 text-left">
                    <i class="fa-check-circle fas mt-0.5 text-green-500 text-xl"></i>
                    <span>Gutscheine zum Ausdrucken wurden erfolgreich erstellt.</span>
                  </li>
