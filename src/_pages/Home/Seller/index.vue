  ...
  <div class="-mt-10 bg-custom-gray">
    <div v-if="!IS_LOADING.status" class="content-container flex flex-col w-full px-8">
      ...
      <div class="bg-peach p-6 mb-10">
        <p class="text-white text-sm">Du musst in <a class="underline" href="/profile-info">Profil &amp; Einstellungen</a> noch deine … hochladen damit die Auszahlung erfolgen kann</p>
      </div>
    </div>
  </div>
</template>
