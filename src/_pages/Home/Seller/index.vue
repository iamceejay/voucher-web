<template>
  <div class="-mt-10 bg-custom-gray">
    ...
    >
      ...
      <div class="main-statistics">
        <div class="main-statistics__container">
          <div class="main-statistics__item">
            ...
            <p class="text-sm font-semibold">
              {{ wallet.voucher_total }} Stück
            </p>
          </div>
          <div class="main-statistics__item">
            <h2>Auszahlung gesamt</h2>
            <p class="text-sm font-semibold mb-4">
              {{ $helpers.convertCurrency(wallet.total_seller_earnings) }}
            </p>
        ...
        <div class="main-statistics__container">
          <div class="main-statistics__item">
            ...
            <p class="text-sm font-semibold">
              {{ $helpers.convertCurrency(wallet.waiting_for_payout) }}
            </p>
          </div>
          <div class="main-statistics__item">
            <h2>Nächste Auszahlung</h2>
            <p class="text-sm font-semibold mb-4">
              in {{ wallet.days_until_next_payout }} Tagen
            </p>
            <p class="text-xs text-custom-gray-2">
              Auszahlung alle {{ wallet.payout_every }} Tage
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="company-bg-color p-6 mb-10" v-if="!isPayoutEnabled">
        <p class="text-white text-sm">
          Du musst in
          <a class="underline" href="/profile-info?currentTab=2"
            >Profil &amp; Einstellungen</a
          >
          unter "Überprüfung" noch Dokumente hochladen, damit die Auszahlung
          erfolgen kann.
        </p>
      </div>
    </div>
