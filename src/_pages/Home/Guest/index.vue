<template>
  <div v-if="!IS_LOADING.status" class="flex flex-col w-full">
    ...
    <div v-if="showAnnouncement" class="modal fixed w-full h-full top-0 left-0 flex items-center justify-center" :class="showAnnouncement ? 'modal-active' : ''">
      <div class="modal-overlay absolute w-full h-full bg-gray-900 opacity-50" @click="showAnnouncement = false"></div>
