<template>
  <div 
    class="flex flex-col m-2 py-2 px-3 border border-gray-900 rounded bg-color text-center w-1/2 md:w-1/4	lg:w-1/5 xl:w-1/6"
  ...
  >
    ...
    <div class="text-sm my-2 font-bold font-display h-8">
      {{ data.name }}
    </div>
