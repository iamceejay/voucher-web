      ...
      <div class="flex flex-col gap-4 md:grid justify-center md:grid-cols-2 pt-12 w-full">
        <div class="flex flex-col">
          ...
          <VoucherCard
            ...
            :isFlippable="false"
          />
          <div class="flex max-w-xs mt-4 mx-auto space-x-3 w-full">
            <button type="button" @click="prev()" class="bg-peach px-5 py-3 rounded-md text-sm text-white">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"/>
              </svg>
            </button>
            <button type="button" @click="next()" class="bg-peach px-5 py-3 rounded-md text-sm text-white">
