<template>
  <div class="flex flex-col w-full">
        ...
        <div class="flex flex-row">
          ...
          <div class="tooltip ml-1">
            ...
            <span class="tooltiptext">
              Teile uns hier deinen Firmennamen mit. Dieser Name wird auch auf
              der Rechnung bei einem Gutscheinverkauf angeführt.
            </span>
          </div>
        </div>
      </template>
    ...
    >
      <template #label_>
        <div class="flex flex-row">
          <Header5 label="Name auf Gutschein" v-if="type == 'seller'" />
          <Header5 label="Benutzername" v-if="type == 'user'" />
          <div class="tooltip ml-1" v-if="type == 'seller'">
            <i class="fas fa-info-circle text-base text-gray-700" />
            <span class="tooltiptext">
              Wähle einen Wunschnamen als Benutzername. Der Benutzername ist auf
              dem Gutschein ersichtlich und kann im Nachhinein nicht mehr
              geändert werden.
            </span>
          </div>
        </div>
