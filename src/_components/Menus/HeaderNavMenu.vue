    ...
    >
      ...
      >
        <a
          ...
          :class="
            `flex flex-col sm:hidden self-center menu-toggle ${
              !hideSidebar ? 'hide' : ''
            }`
          "
          @click="onHideSidebar()"
        ...
        <a
          ...
          href="javascript:void(0)"
          :class="
            `flex flex-col sm:hidden self-center ${!hideSidebar ? 'hide' : ''}`
          "
          @click="
            showWallet = true;
            isRegisterPop = true;
      ...
      <div
        ...
        class="border border-black mx-8 opacity-25"
      ...
      >
        <div
          ...
          :class="
            AUTH_USER.isAuth && AUTH_USER.role.name !== 'user'
              ? 'flex-col space-y-4'
              : 'flex-row space-x-4 items-center flex-1 justify-center'
          "
        >
          <a
            ...
            >
              ...
              >
                <use
                  :xlink:href="
                    `/icons/sprite.svg#${
                      menu.isChildShow ? 'x-circle' : menu.icon
                    }`
                  "
                />
              </svg>
              ...
              >
                <i :id="`dropdown-${index}`" class="fas fa-caret-down" />
              </span>
            </span>
            <!-- <div v-if="menu.child && menu.isChildShow" class="fixed inset-0 z-0" /> -->
            <div
              v-if="
                menu.child && menu.isChildShow && AUTH_USER.role.name !== 'user'
              "
        ...
        >
          ...
          >
            ...
            <span class="text-sm">Meine Wunschliste</span>
          </router-link>
          <router-link
            v-if="
              hideSidebar &&
          ...
          >
            <div class="relative  h-4 w-4">
              <svg
                ...
                height="16"
                fill="currentColor"
                class="relative icon h-4 w-4 text-peach"
                viewBox="0 0 16 16"
              >
                <path
                  fill-rule="evenodd"
      ...
      >
        <div
          ...
          :class="
            AUTH_USER.isAuth && AUTH_USER.role.name !== 'user'
              ? 'flex-col space-y-4'
              : 'flex-row items-center space-x-4 flex-1 justify-center'
          "
        >
          <a
